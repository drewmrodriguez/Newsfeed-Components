...
const article = {title: "Some String", date: "11/11/32", firstParagraph: "", secondParagraph: "", thirdParagraph: ""};
...
const articleMaker = (article) => {
  ...
  articleDiv.append(articleP1, articleP2, articleP3, articleSpan)
